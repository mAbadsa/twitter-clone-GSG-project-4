...
const state = {
  userlogin: {
    id: "username_1_552525",
    name: "username_1",
    username: "@username_1",
    avatar: "./src/image/avatar/images_5.jpg",
  },
};
...
function listTweet(tweet) {
  const tweetListTemplate = `
            <div class="tweet-box">
            ${
              tweet.tweetStatus
                ? `<div class="tweet-box_tweet-status">
                ...
                <div class="tweet-body-box">
                  ...
                  <div class="tweet-box__body">
                    <div class="tweet-box__body_header">
                      <div class="tweet-box_tweet-data">
                        ...
                        <div class="tweet_createdAt">
                          <span> ${state.userlogin.createdAt}</span>
                        </div>
                      </div>
                    ...
                    <div class="tweet-box__body_footer">
                      <div class="tweet-interactive_box">
